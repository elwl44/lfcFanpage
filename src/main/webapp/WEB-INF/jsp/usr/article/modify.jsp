...
<body>
    ...
    <section class="section-modify row">
        ...
        <form onsubmit="ArticleModify__checkAndSubmit(this); return false;" action="doModify" enctype="multipart/form-data">
		            ...
		            <c:forEach begin="1" end="${fileInputMaxCount}" var="inputNo">
		             <div class="detail-img row">
		            	...
		            	<c:if test="${file != null && file.fileExtTypeCode == 'img'}">
		            		<span class="cell">첨부파일${inputNo} </span>
							<img src="${file.forPrintUrl}" class="cell">
						</c:if>
						</div>
					</c:forEach>
