    ...
    <div class="site-header">
        <div class="head1 row">
            <ul class="row cell-right">
                <li class="cell"><a href="../member/login">로그인</a></li>
            ...
            <div class="head-info-right cell">
                <div class="team-info row">
                    <div class="team-info-img1 cell">
                        <img class="img1 cell" src="/resource/img/logo-pl-champs-desk-3@2x.png" />
                    </div>
                    <div class="team-info-img2 cell-right">
                        <img class="img2 cell" src="/resource/img/sponsor-header-xlarge-2.png" />
                    </div>
                </div>
                <div class="menu">
                    <ul class="top_menu row">
                        <li class="cell"><a href="/usr/article/home">HOME</a></li>
                        <li class="cell"><a href="/usr/article/notice">공지</a></li>
                        <li class="cell"><a href="#team">TEAM</a></li>
                        <li class="cell"><a href="#news">NEWS</a></li>
                        <li class="cell"><a href="#comunity">커뮤니티</a>
                            <ul>
                                <li><a href="#soccer-article">축구게시판</a></li>
                                <li><a href="#free-article">자유게시판</a></li>
                            </ul>
                        </li>
                        <li class="cell"><a href="#">LEAGUE TABLE</a></li>
                    </ul>
                </div>
            </div>
        </div>
